...
var SimpleLog__level = LOOKUP[LEVELS.VERBOSE]
var SimpleLog__userFunction = null
...
export const formatString = (lvlString, str, params) =>{
    ...
    return `[${lvlString}][${moment().format('YYYY-MM-DD HH:mm:ss')}]${parameters} ${unicorn(str, params)}`
}

export const universalLog = (levelString, str, params) => {
    let level = LOOKUP[levelString] || 4
